VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptCardInfo 
   Bindings        =   "rptCardInfo.dsx":0000
   Caption         =   "Student Scrach Card Information"
   ClientHeight    =   8715
   ClientLeft      =   210
   ClientTop       =   615
   ClientWidth     =   8535
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   16711680
         Object.Caption         =   "Student Scratch Card Details"
         Alignment       =   2
      EndProperty
      ItemType2       =   3
